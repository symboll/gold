...
THREE.ParametricGeometries = {
  ...
  mobius3d: function (u, t) {
    ...
    u = u * 2
    var phi = u / 2
    var major = 2.25; var a = 0.125; var b = 0.65
    var x, y, z
...
THREE.ParametricGeometries.TubeGeometry = function (path, segments, radius, segmentsRadius, closed, debug) {
  ...
  var tangent; var normal; var binormal

  var numpoints = this.segments + 1

  var x; var y; var z; var tx; var ty; var tz; var u; var v

  var cx; var cy; var pos; var pos2 = new THREE.Vector3()
  var i; var j; var ip; var jp; var a; var b; var c; var d; var uva; var uvb; var uvc; var uvd
...
THREE.ParametricGeometries.TorusKnotGeometry = function (radius, tube, segmentsR, segmentsT, p, q, heightScale) {
  ...
  var TorusKnotCurve = THREE.Curve.create(
    ...
    function (t) {
      ...
      var ty = (1 + r * Math.cos(q * t)) * Math.sin(p * t)
      var tz = r * Math.sin(q * t)
...
export default THREE.ParametricGeometries
